...
Matrix operator+(Matrix& M1, Matrix& M2) {
    int M1Rows = M1.getNumberOfRows();
    int M1Columns = M1.getNumberOfColumns();
    int M2Rows = M2.getNumberOfRows();
    int M2Columns = M2.getNumberOfColumns();
...
Matrix operator*(double number, Matrix& M) {
    int MRows = M.getNumberOfRows();
    int MColumns = M.getNumberOfColumns();
